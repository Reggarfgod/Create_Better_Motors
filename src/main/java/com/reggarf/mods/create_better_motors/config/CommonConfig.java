...
public class CommonConfig {
    ...
    private static MotorConfig motor(ForgeConfigSpec.Builder builder, String category,
    ...
    private static AlternatorConfig alternator(ForgeConfigSpec.Builder builder, String category,
